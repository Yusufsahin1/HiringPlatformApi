...
public class JobPostingDtoConverter {
    public static JobPostingDto toDto(JobPosting jobPosting) {
        return new JobPostingDto(jobPosting.getId(), jobPosting.getTitle(), jobPosting.getDescription(), jobPosting.getLocation(), CompanyDtoConverter.toDto(jobPosting.getCompany()));
    }
}
